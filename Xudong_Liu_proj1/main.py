...
image_list = ['cathedral.jpg', 'emir.tif', 'harvesters.tif', 'icon.tif', 'lady.tif',
 'melons.tif', 'monastery.jpg', 'onion_church.tif', 'self_portrait.tif',
  'three_generations.tif', 'tobolsk.jpg', 'train.tif', 'village.tif', 'workshop.tif',
 'buildings.tif', 'three_girls.tif', 'wooden_church.tif']
...
for imname in image_list:
    ...
    # save the image
    fname = os.path.join(os.getcwd(), 'out_path', imname.split('.')[0] + '.jpg')
